...
import { deleteServices } from "@/actions/service"
...
export function DataTable<TData, TValue>({columns, data}: DataTableProps<TData, TValue>) {
    ...
    React.useEffect(() => {
      const selectedIds = table
        ...
        .map(item => (item.original as Service).id);
    ...
    const handleDelete = async () => {
      ...
      const result =  await deleteServices(selectedIds)
      ...
      if(result.status === 'success') {
        ...
        toast.success("Serviços excluídos", {
          description: "Serviços foram excluídos com sucesso",
        })
      }
              ...
              <TableBody>
                  ...
                  table.getRowModel().rows.map((row) => {
                      ...
                      >
                          ...
                          {/* actions */}
                          <TableCell>
                            <DropdownMenuActions service={ service }/>                            
                          </TableCell>
